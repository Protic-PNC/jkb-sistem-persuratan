        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form method="post" action="/dashboard/admin/pernyataan-magang/{{ $pernyataans->noSurat }}">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_mhs') is-invalid @enderror" id="nama_mhs" name="nama_mhs" required value="{{ old('nama_mhs', $pernyataans->nama_mhs) }}">
                            @error('nama_mhs')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('npm') is-invalid @enderror" id="npm" name="npm" required value="{{ old('npm', $pernyataans->npm) }}">
                            @error('npm')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" name="jurusan" required value="{{ old('jurusan', $pernyataans->jurusan) }}">
                            @error('jurusan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('perguruan_tinggi') is-invalid @enderror" id="perguruan_tinggi" name="perguruan_tinggi" required value="{{ old('perguruan_tinggi', $pernyataans->perguruan_tinggi) }}">
