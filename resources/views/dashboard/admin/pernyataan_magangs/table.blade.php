                ...
                <td>
                    <div class="d-flex justify-content-start">
                        ...
                        <a class="btn btn-sm btn-warning me-2"
                            href="/dashboard/admin/pernyataan-magang/{{ $pernyataan->noSurat }}/edit">Edit</a>
                        <form action="/dashboard/admin/pernyataan-magang/{{ $pernyataan->noSurat }}" method="post"
                        ...
                        <a class="btn btn-sm btn-success"
                            href="/dashboard/admin/pernyataan-magang/{{ $pernyataan->noSurat }}/cetak">Cetak</a>
                    </div>
                </td>
            </tr>
        @endforeach
