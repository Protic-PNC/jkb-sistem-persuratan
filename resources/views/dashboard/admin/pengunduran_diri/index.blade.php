        ...
        <div class="bg-light text-center rounded p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="/dashboard/admin/pengunduran-diri/create" class="btn btn-primary">Tambah Surat</a>
                    <button type="button" class="btn btn-danger" onclick="confirmResetPengunduranDiri()"><i
                            class="bi bi-trash"></i> Reset Data</button>
                </div>
            </div>

            <div class="table-responsive">
                @include('dashboard.admin.pengunduran_diri.table')
            </div>
        </div>
    </div>
@endsection
