                    ...
                    <div class="d-flex justify-content-start">
                        ...
                        @if ($pengunduran->status_surat != 'ditolak')
                            <a class="btn btn-sm btn-warning me-3"
                                href="/dashboard/mahasiswa/pengunduran-diri/{{ $pengunduran->noSurat }}/edit">Edit</a>
                        @endif
                        <form action="/dashboard/mahasiswa/pengunduran-diri/{{ $pengunduran->noSurat }}" method="post"
                            class="d-inline" id="delete-form-{{ $pengunduran->noSurat }}">
                            @method('delete')
                            @csrf
                        ...
                        <a class="btn btn-sm btn-success me-3"
                            href="/dashboard/mahasiswa/pengunduran-diri/{{ $pengunduran->noSurat }}/cetak">Cetak</a>
                    </div>
                </td>
            </tr>
        @endforeach
