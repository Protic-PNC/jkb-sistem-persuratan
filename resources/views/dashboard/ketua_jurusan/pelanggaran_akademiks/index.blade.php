    ...
    <div class="row g-4">
        <div class="col-sm-6 col-xl-6">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    <p class="mb-2">Total Surat Peringatan karena Pelanggaran Akademik Semua Kelas
                        {{ $kelas->nama_kelas ?? '...' }}</p>
        ...
        <div class="col-sm-6 col-xl-6">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                <i class="fa fa-chart-line fa-3x text-primary me-3"></i>
                <div class="ms-3">
                    <p class="mb-2">Total Surat Peringatan karena Pelanggaran Akademik Ketua Jurusan</p>
        ...
        <div class="bg-light text-center rounded p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 id="table-title" class="mb-0" data-kelas="{{ $kelas->nama_kelas ?? '' }}">Daftar Surat Peringatan
                    karena Pelanggaran Akademik Semua Kelas</h6>
                <a href="/dashboard/ketua-jurusan/pelanggaran-akademik/create" class="btn btn-primary">Tambah Surat</a>
            </div>
