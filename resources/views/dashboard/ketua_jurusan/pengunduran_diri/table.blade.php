                    ...
                    <div class="d-flex justify-content-start">
                        ...
                        @if ($pengunduran->status_surat != 'ditolak')
                            <a class="btn btn-sm btn-warning me-3"
                                href="/dashboard/ketua-jurusan/pengunduran-diri/{{ $pengunduran->noSurat }}/edit">Edit</a>
                        @endif
                        <form action="/dashboard/ketua-jurusan/pengunduran-diri/{{ $pengunduran->noSurat }}"
                        ...
                        @if ($pengunduran->status_surat != 'ditolak')
                            <form action="/dashboard/ketua-jurusan/pengunduran-diri/{{ $pengunduran->noSurat }}/tolak"
