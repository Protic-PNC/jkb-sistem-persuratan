@extends('dashboard.bagian_keuangan.layouts.main')
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form id="update-form-pengunduran" method="post" enctype="multipart/form-data"
                        action="/dashboard/bagian-keuangan/pengunduran-diri/{{ $pengundurans->noSurat }}">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            <label for="ttd_dosen_wali" class="form-label">Upload Tanda Tangan Wali Kelas</label>
                            @if ($pengundurans->ttd_dosen_wali)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $pengundurans->ttd_dosen_wali) }}"
                                        alt="Tanda Tangan Dosen Wali" class="img-preview" width="100px">
                                </div>
                                <input type="hidden" name="original_ttd_dosen_wali"
                                    value="{{ $pengundurans->ttd_dosen_wali }}">
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            @if ($pengundurans->ttd_ketua_jurusan)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $pengundurans->ttd_ketua_jurusan) }}"
                                        alt="Tanda Tangan Ketua Jurusan" class="img-preview" width="100px">
                                </div>
                                <input type="hidden" name="original_ttd_ketua_jurusan"
                                    value="{{ $pengundurans->ttd_ketua_jurusan }}">
                            @endif
                        ...
                        <a href="/dashboard/bagian-keuangan/pengunduran-diri" class="btn btn-success"><i
