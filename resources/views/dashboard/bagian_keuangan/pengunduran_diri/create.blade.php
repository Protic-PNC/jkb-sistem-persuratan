        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form id="create-form-pengunduran" method="post" action="/dashboard/bagian-keuangan/pengunduran-diri"
                        ...
                        <!-- Upload TTD Bagian Keuangan -->
                        <div class="mb-3">
                            <label for="ttd_bagian_keuangan" class="form-label">Upload Tanda Tangan Bagian
                                Keuangan</label>
                            <input type="file" class="form-control @error('ttd_bagian_keuangan') is-invalid @enderror"
                                id="ttd_bagian_keuangan" name="ttd_bagian_keuangan">
                            @error('ttd_bagian_keuangan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
