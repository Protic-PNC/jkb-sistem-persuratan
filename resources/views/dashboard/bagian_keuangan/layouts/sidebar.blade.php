...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="/dashboard/bagian-keuangan"
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/dashboard/bagian-keuangan/pengunduran-diri"
                        class="dropdown-item {{ Request::is('dashboard/bagian-keuangan/pengunduran-diri*') ? 'active' : '' }}">
                        Surat Pengunduran
                        Diri</a>
                </div>
            </div>
