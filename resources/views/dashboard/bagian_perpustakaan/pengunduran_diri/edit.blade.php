            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form id="update-form-pengunduran" method="post" enctype="multipart/form-data"
                        action="/dashboard/bagian-perpustakaan/pengunduran-diri/{{ $pengundurans->noSurat }}">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            <label for="ttd_bagian_perpustakaan" class="form-label">Upload Tanda Tangan Bagian
                                Perpustakaan</label>
                            @if ($pengundurans->ttd_bagian_perpustakaan)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $pengundurans->ttd_bagian_perpustakaan) }}"
                                        alt="Tanda Tangan Ketua Jurusan" class="img-preview" width="100px">
                                </div>
                                <input type="hidden" name="original_ttd_bagian_perpustakaan"
                                    value="{{ $pengundurans->ttd_bagian_perpustakaan }}">
                            @endif
                            <input type="file"
                                class="form-control @error('ttd_bagian_perpustakaan') is-invalid @enderror"
                                id="ttd_bagian_perpustakaan" name="ttd_bagian_perpustakaan">
                            @error('ttd_bagian_perpustakaan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                        </div>
                        <a href="/dashboard/bagian-perpustakaan/pengunduran-diri" class="btn btn-success"><i
