...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="/dashboard/bagian-perpustakaan"
                class="nav-item nav-link {{ Request::is('dashboard') ? 'active' : '' }}"><i
                    class='fas fa-clipboard-list me-2'></i>Dashboard</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::is('pengundurans') ? 'active' : '' }}"
                    data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Surat</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/dashboard/bagian-perpustakaan/pengunduran-diri"
                        class="dropdown-item {{ Request::is('dashboard/bagian-perpustakaan/pengunduran-diri*') ? 'active' : '' }}">
                        Surat Pengunduran
                        Diri</a>
                </div>
            </div>
