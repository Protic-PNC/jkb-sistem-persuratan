...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        @include('dashboard.bagian_perpustakaan.layouts.sidebar')

        {{-- Content Start --}}
        <div class="content">
            @include('dashboard.bagian_perpustakaan.layouts.header')

            @yield('container')

            @include('dashboard.bagian_perpustakaan.layouts.footer')
        </div>
        {{-- Content End --}}
        <!-- Back to Top -->
