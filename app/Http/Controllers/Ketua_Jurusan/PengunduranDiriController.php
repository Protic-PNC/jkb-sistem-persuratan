...
class PengunduranDiriController extends Controller
{
    ...
    return view('dashboard.ketua_jurusan.pengunduran_diri.index', [
    ...
    public function create()
    {
        ...
        return view('dashboard.ketua_jurusan.pengunduran_diri.create', compact('kelas', 'user'), [
            'title' => 'Permohonan Pengunduran Diri',
        ]);
    }
    ...
    {
        return view('dashboard.ketua_jurusan.pengunduran_diri.show', [
            'title' => 'Permohonan Pengunduran Diri',
    ...
    public function edit(PengunduranDiri $pengunduranDiri)
    {
        $kelas = Kelas::all();
        $user = Auth::user();
        return view('dashboard.ketua_jurusan.pengunduran_diri.edit', compact('kelas', 'user'), [
            'title' => 'Edit',
            'pengundurans' => $pengunduranDiri,
        ]);
    }
...
{   
    ...
    return redirect('/dashboard/ketua-jurusan/pengunduran-diri');
}
...
if ($pengunduranDiri->status_surat == 'selesai' && $statusSebelumnya != 'selesai' && $user) {
    ...
    {
        $pdf = Pdf::loadview('dashboard.ketua_jurusan.pengunduran_diri.cetak', [
            'title' => 'Cetak',
            'pengundurans' => $pengunduranDiri,
    ...
    public function tolak(PengunduranDiri $pengunduranDiri)
{
    ...
    return redirect('/dashboard/ketua-jurusan/pengunduran-diri')->with('status', 'Surat ditolak');
}
}
